    ...
    return (
        ...
        lg:w-[13%] xl:w-[9.8%]">
            ...
            <motion.nav variants={variants} animate={controls} initial="hidden" className={
                cn('-mt-4 -ml-3 -mr-3 w-[calc(100%+6rem)] bg-black md:w-full md:bg-transparent md:m-0',
                    'md:clear-trs',
                )
            }>
                <ul className={cn(
                    ...
                    <li className="py-3 md:py-1 font-semibold leading-relaxed text-base xl:text-[1vw]">
                        <Link href="#">
                            <a className={cn('font-sec',{'hover:text-white': isMobile}, {'text-white': router.pathname === '/' && isMobile})}>Nosotros</a>
                        </Link>
                    </li>
                    <li className="py-3 md:py-1 font-semibold leading-relaxed text-base xl:text-[1vw]">
                        <Link href="#">
                            <a className={cn('font-sec',{'hover:text-white': isMobile})}>Proyectos</a>
                        </Link>
                    </li>
                    <li className="py-3 md:py-1 font-semibold leading-relaxed text-base xl:text-[1vw]">
                        <Link href="#">
                            <a className={cn('font-sec',{'hover:text-white': isMobile})}>Servicios</a>
                        </Link>
                    </li>
                    <li className="py-3 md:py-1 font-semibold leading-relaxed text-base xl:text-[1vw]">
                        <Link href="#">
                            <a className={cn('font-sec',{'hover:text-white': isMobile})}>Contacto</a>
                        </Link>
                    </li>
                </ul>
            </motion.nav>
